...
tf.app.flags.DEFINE_string('input_directory', './INPUT',
                           'Input data directory')
tf.app.flags.DEFINE_string('output_file', './OUTPUT/model.tfrecords',
                           'Output file')
tf.app.flags.DEFINE_string('labels_file', './labels_file.txt',
                           'Labels file')
...
def _load_image(addr):
  ...
  #ALTERNATIVA img = cv2.imread(addr, cv2.IMREAD_GRAYSCALE) 
...
def main(unused_argv):
  ...
  # Create a feature
  feature = {'labels': _int64_feature(labels),
